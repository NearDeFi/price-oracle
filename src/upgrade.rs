...
mod upgrade {
    ...
    const GAS_FOR_VERIFICATION_CALL: Gas = Gas(Gas::ONE_TERA.0 * 5);
    ...
    pub extern "C" fn upgrade() {
        ...
        unsafe {
            ...
            let required_gas =
                env::used_gas() + GAS_TO_COMPLETE_UPGRADE_CALL + GAS_FOR_VERIFICATION_CALL;
            require!(
